...
//        super.render(stack, matrix, bufferIn, combinedLightIn, combinedOverlayIn);
        ...
        Minecraft.getInstance().getItemRenderer().renderItem(new ItemStack(Itemz.BREAD_SLICE.get()), TransformType.FIXED, combinedLightIn, combinedOverlayIn, matrix, bufferIn);
